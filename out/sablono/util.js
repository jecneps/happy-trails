...
/** @this {Function} */
sablono.util.as_str.cljs$lang$applyTo = (function (seq619){
...
var vec__623 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__625;
var words = seq__624__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__626){
var vec__627 = p__626;
...
return cljs.core.update.call(null,G__630,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__630;
}
} else {
